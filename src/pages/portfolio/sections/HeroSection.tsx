...
const COMIC_LINES = [
  ...
  'Saving the web, one component at a time!',
...
const NEWS_LINES = [
  ...
  'Full-stack development, Tokyo-based.',
...
const COMIC_BURSTS = [
  { word: 'POW!',  top: '12%', left: '6%',  rotate: '-12deg', delay: '0s',   size: '4.5rem' },
  { word: 'ZAP!',  top: '10%', right: '5%', rotate: '8deg',   delay: '0.3s', size: '4rem'   },
  { word: 'WHAM!', top: '65%', left: '3%',  rotate: '-6deg',  delay: '0.6s', size: '3.5rem' },
];
...
function TypewriterText({ theme }: { theme: PortfolioTheme }) {
  ...
  }, [charIndex, erasing, lineIndex, lines, isCrossing]);
      ...
      <div style={{ position: 'relative', maxWidth: 'min(400px, 88vw)' }}>
        <div style={{
          ...
          <span style={{
            ...
            {displayed}
            <span style={{ animation: 'blink-cursor 0.8s step-end infinite', color: theme.primary }}>
              {theme.typingCursor}
            </span>
          </span>
          {/* Bubble tail */}
  ...
  /* ── Newspaper BREAKING NEWS block ── */
  if (isNewspaper) {
    return (
      <div style={{ maxWidth: 'min(600px, 88vw)', textAlign: 'left' }}>
        ...
        <div style={{
          ...
          {displayed}
          <span style={{ animation: 'blink-cursor 1s step-end infinite', color: '#8B0000' }}>
            {theme.typingCursor}
          </span>
        </div>
      </div>
    ...
    return (
      <div style={{
        ...
        <span style={{
          ...
          {displayed}
          <span style={{ animation: 'blink-cursor 0.8s step-end infinite', color: theme.secondary, marginLeft: '2px' }}>
            |
          </span>
        </span>
      </div>
  ...
  return (
    <div style={{
      ...
      {displayed}
      <span style={{ animation: 'blink-cursor 1s step-end infinite', color: theme.primary }}>
        {theme.typingCursor}
      </span>
    </div>
  );
    ...
    return (
      ...
      >
        <div style={{
          ...
          {/* Double-ruled top */}
          <div style={{ width: '100%', borderTop: '4px double #1a1a1a', marginBottom: '0.6rem' }} />
          ...
          {/* Thin rule */}
          <div style={{ width: '100%', borderTop: '1px solid #1a1a1a', marginBottom: '0.5rem' }} />
          ...
          <div style={{
            ...
            Tokyo, Japan &nbsp;·&nbsp; Software Engineer &nbsp;·&nbsp; Est. 2020
          </div>

          {/* Double-rule */}
          <div style={{ width: '100%', borderTop: '3px solid #1a1a1a', marginBottom: '1.5rem' }} />
          ...
          <h1 style={{
            ...
            Local Engineer Available for Hire
          </h1>
          ...
          <p style={{
            ...
            Specialising in full-stack development, React, and TypeScript
          </p>

          {/* Rule before typewriter */}
          <div style={{ width: '100%', borderTop: '1px solid #AAAAAA', marginBottom: '1.2rem' }} />
    ...
    >
        ...
        <>
          ...
          <div style={{
            ...
            {['12%','25%','38%','52%','67%','80%','91%'].map((l, i) => (
              <span key={i} style={{
                position: 'absolute', left: l, top: '-10px',
                fontSize: '1.2rem',
      ...
      <div style={{
        ...
        {isCrossing ? (
          ...
          <div style={{
            ...
            {[
              { top: 10, left: 14 }, { top: 10, right: 14 },
              { bottom: 10, left: 14 }, { bottom: 10, right: 14 },
            ].map((pos, i) => (
              <span key={i} style={{ position: 'absolute', fontSize: '1rem', ...pos }}>✿</span>
            ))}
          ...
          /* ── HUD title frame ── */
          <div style={{ position: 'relative', display: 'inline-block', padding: '2rem 3rem' }}>
            {[
              { top: 0, left: 0,  borderTop:    `2px solid ${theme.primary}`, borderLeft:  `2px solid ${theme.primary}` },
              { top: 0, right: 0, borderTop:    `2px solid ${theme.primary}`, borderRight: `2px solid ${theme.primary}` },
              { bottom: 0, left: 0,  borderBottom: `2px solid ${theme.primary}`, borderLeft:  `2px solid ${theme.primary}` },
              { bottom: 0, right: 0, borderBottom: `2px solid ${theme.primary}`, borderRight: `2px solid ${theme.primary}` },
            ].map((style, i) => (
            ...
            <div style={{
              ...
              animation: 'targeting-spin 12s linear infinite', pointerEvents: 'none',
            }}>
              <div style={{
                position: 'absolute', top: '50%', left: '-4px',
                width: '8px', height: '2px', background: theme.primary,
                transform: 'translateY(-50%)',
              }} />
            </div>
            <h1 style={{
              fontFamily: theme.fontHeading, fontSize: 'clamp(2rem, 6vw, 4rem)',
              fontWeight: 900, margin: 0, color: theme.primary,
              letterSpacing: '0.1em', animation: theme.glowAnimation,
            }}>
              HIROSHI FUJI
            </h1>
            <div style={{
              fontFamily: theme.fontBody, fontSize: 'clamp(0.8rem, 1.5vw, 1rem)',
              color: theme.text, letterSpacing: '0.3em', marginTop: '0.5rem',
            }}>
              SOFTWARE ENGINEER
            </div>
          </div>
      ...
      <div
        style={{
          ...
          letterSpacing: '0.15em',
          animation: isCrossing ? 'ac-bounce 1.8s ease-in-out infinite' : 'scroll-bounce 2s ease-in-out infinite',
          cursor: 'pointer',
        }}
        onClick={() => document.getElementById('bio')?.scrollIntoView({ behavior: 'smooth' })}
      >
